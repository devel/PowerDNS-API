...
# Generated on Tue Nov 20 21:17:56 2012 UTC, by
...

{
    ...
    with qw(
      PowerDNS::API::Schema::Role::Account
      PowerDNS::API::Schema::_mesoderm
    );
    no Moose;
...

{
    ...
    with qw(
      PowerDNS::API::Schema::Role::Domain
      PowerDNS::API::Schema::_mesoderm
    );
    no Moose;
...

{
    ...
    with qw(
      PowerDNS::API::Schema::Role::Record
      PowerDNS::API::Schema::_mesoderm
    );
    no Moose;
